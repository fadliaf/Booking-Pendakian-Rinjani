<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight flex-grow text-center">
               {{ $jalurs->first()->nama_jalur }}
            </h2>
            <a href="{{ route('booking.tiket') }}" class="font-semibold text-lg text-white bg-green-700 hover:bg-green-800 py-2 px-2 rounded">
                {{ __('Booking') }}
            </a>
        </div>
    </x-slot>
    ...
    <div class="py-12 min-h-screen bg-cover bg-center"
        style="background-image: url('{{ asset('images/gunungrinjanilombok21.jpg') }}');">
